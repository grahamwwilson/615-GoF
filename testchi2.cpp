...
int main(int argc, char *argv[]){
   ...
   const unsigned int NTHROWS = 100000;
   std::cout << "Chi-squared with " << N << " degrees-of-freedom" << std::endl;
   std::cout << "Number of random variates generated " << NTHROWS << std::endl;
   std::vector<double> v;
...
// Simulate a chi-squared distribution with N degrees of freedom
   ...
   std::cout << "p-value of " << pvalue << std::endl;
